<x-app>
    ...
    <div class="card shadow-lg p-3">
        <div class="mb-3">
            <a class="btn btn-primary" href="{{ route('warehouse.create') }}" role="button">
            ...
            <table class="table table-bordered table-striped w-100" id="data-table">
                <thead>
                    <tr>
                        ...
                        <th scope="col">Manajer Gudang</th>
                        ...
                        <tr>
                            ...
                            <td>
                                <button type="button" class="btn btn-info btn-sm btn-detail"
                                    data-route="{{ route('warehouse.show', $warehouse) }}">
                                    <i class='bx bx-show'></i>
                                </button>
                                <a href="{{ route('warehouse.edit', $warehouse) }}" class="btn btn-warning btn-sm">
                                    <i class='bx bx-edit-alt'></i>
                                </a>
                                <button type="button" class="btn btn-danger btn-sm btn-delete" data-bs-toggle="modal"
                                    data-bs-target="#deleteModal" data-route="{{ route('warehouse.destroy', $warehouse) }}">
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h1 class="modal-title fs-5">Detail Gudang</h1>
